...
os.makedirs(f"../data/FashionMNIST/num_elements={num_elements}", exist_ok=True)
np.save(f'../data/FashionMNIST/num_elements={num_elements}/train_sets.npy', train_sets)
np.save(f'../data/FashionMNIST/num_elements={num_elements}/test_sets.npy', test_sets)
...
def plot_image_from_coordinates(coordinate_set):
    ...
    torchvision.utils.save_image(grid, f"../data/FashionMNIST/num_elements={num_elements}/set_to_image.png")
    # plt.figure()
